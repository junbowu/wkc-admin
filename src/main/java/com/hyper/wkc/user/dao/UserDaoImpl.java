...
*/
package com.hyper.wkc.user.dao;
 ...
 * @author  泡面和尚
 * @date  2018年1月6日 上午2:27:57
 */
@Repository
public class UserDaoImpl extends AbstractBaseMongoDao<User>{

	@Override
	public String getCollectionName() {
		return CollectionConst.WKC_USER;
	}

	public void doLogin(User user) {
		if (WkcApiHelper.doLogin(user)) { //登录成功
			save(user);
		}
	}
